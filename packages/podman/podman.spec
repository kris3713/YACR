...
BuildRequires:  gcc glib2-devel glibc-devel glibc-static golang git-core
...
BuildRequires:  libselinux-devel shadow-utils-subid-devel pkgconfig make man-db
BuildRequires:  sqlite-devel systemd systemd-devel
Requires:       catatonit conmon >= 2:2.1.7-2
...
Requires: attr jq skopeo nmap-ncat httpd-tools openssl socat slirp4netns buildah gnupg xfsprogs
...
%__ln -s ../virtiofsd %{buildroot}%{_libexecdir}/%{name}
%endif
