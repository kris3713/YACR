...
%__install -d %{buildroot}{%{_bindir},/lib/die,%{_datadir}/applications,%{_datadir}/icons/hicolor/256x256/apps,%{_datadir}/icons/hicolor/48x48/apps,%{_datadir}/icons/hicolor/32x32/apps,%{_datadir}/icons/hicolor/24x24/apps,%{_datadir}/icons/hicolor/20x20/apps,%{_datadir}/icons/hicolor/16x16/apps}
