...
Conflicts:      %{full_name}-gtk2 %{full_name}-qt5 %{full_name}-qt6
...
%__install -D -m 0644 %{buildroot}/opt/%{app_name}/%{full_name}-512.png %{buildroot}%{_datadir}/icons/hicolor/512x512/apps/%{full_name}.png
